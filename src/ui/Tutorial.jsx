...
const STEPS = [
  ...
  },
  {
    ...
    text: 'Внизу екрану панель із засобами ураження. Обери потрібний тип та клікни на карту, щоб розмістити. Сусідні клітинки біля вже зайнятої позиції теж блокуються, тож оборону треба розтягувати.',
  },
  {
    title: 'Перший засіб',
    text: '🔫 Турель найдешевша і найточніша, але тепер перегрівається після довгої черги. 🚗 МВГ патрулює район і покриває більшу площу.',
  },
  {
    title: 'Запуск хвилі',
    text: 'Кнопка «🚀 Хвиля!» запускає атаку ворога. Між хвилями можна розміщувати нові засоби, ремонтувати будівлі та аварійно відновлювати знищені обʼєкти.',
  },
  {
    title: 'Іскандер!',
  ...
  {
    title: 'Невидимі цілі',
    text: 'Деякі дрони та ракети проходять глибоко на великій висоті або низько над рельєфом, а вже потім розгортаються на ціль. Тримай частину оборони ближче до критичних обʼєктів і не стискай усе в один вузол.',
    emoji: '👻',
  },
  {
    title: 'В бій!',
