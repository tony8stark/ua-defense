...
const EVENTS = [
  ...
  },
  {
    ...
    desc: 'Туман (-30% дальність), ніч (-20% точність турелей), вітер (-15% точність + знос), шквал ще сильніше ріже дальність і точність. На пізніх та endless-хвилях погода гірша.',
  },
  {
    emoji: '🧰', name: 'Утримання', color: '#f59e0b',
    desc: 'Між хвилями активна оборона коштує грошей. Чим більше живих і прокачаних засобів, тим болючіший upkeep.',
  },
  {
