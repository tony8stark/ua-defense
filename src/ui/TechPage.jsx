...
const DEFENSE = [
  ...
  },
  {
    ...
    desc: 'Мобільна вогнева група. Патрулює район на 2 клітинки від позиції. Менш точна, ніж стаціонарна турель, але контролює більшу площу.',
    stats: 'Патрулювання: +-2 клітинки | Урон: як турель | Макс: 2-4',
  },
  {
  ...
  },
  {
    ...
    desc: 'Преміальний зенітний комплекс. Одна ракета за раз, але гарантоване знищення. Цілить по найздоровішому ворогу.',
    stats: 'Дальність: велика | Урон: миттєва смерть | Перезарядка: 8с',
  },
  {
...
const ENEMIES = [
  ...
  },
  {
    ...
    desc: 'Реактивна модифікація. Дуже швидкий, FPV та кукурузники його не бачать. Тільки турелі, HAWK та IRIS-T.',
